...
# "Ann1,Ann2,Ann3,Ann5" "Ann1,Ann2,Ann3,Ann6" "Ann1,Ann2,Ann4,Ann5" "Ann1,Ann2,Ann4,Ann6")
...
for ann_index in  "${!annotators_1[@]}" ; do
    ...
    screen -dmS "$SESSION_NAME" bash -c "CUDA_VISIBLE_DEVICES=$gpu python mtl_test_model.py --budget 4704 \
                                                    --split "test" \
                                                    --mtl_tasks "$tasks_1" \
                                                    --n_fewshot_tasks 0 ;
                                        "
...
# "CUDA_VISIBLE_DEVICES=3 python  mtl_test_model.py \
#                                                     --budget 4704 \
#                                                     --n_fewshot_tasks 0 \ 
#                                                     --split "test" \
